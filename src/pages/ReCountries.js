...
import { SelectDefault } from "./TailSelect";

const ReCountries = ({ nightMode }) => {
  ...
  return (
    ...
    >
      <div className="w-[90%] md:w-[95%] mx-auto mb-6 flex flex-col gap-6 md:flex-row justify-between md:items-start">
        ...
        {/* <div>
        <SelectComponent filterByRegion={filterByRegion} />
      </div> */}
        {/* <div>
        <SelectDefault filterByRegion={filterByRegion} />
      </div> */}
      </div>
      {/* <div className="md:w-[95%] mx-auto flex flex-col md:flex-row flex-wrap gap-12 md:gap-6"> */}
